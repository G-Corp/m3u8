...
<pre><code>
media() = #{default =&gt; boolean(), uri =&gt; binary(), type =&gt; binary(), group_id =&gt; binary(), language =&gt; binary(), default =&gt; boolean(), autoselect =&gt; boolean(), forced =&gt; boolean(), characteristics =&gt; binary(), assoc_language =&gt; binary(), stream_id =&gt; binary(), channels =&gt; binary()}
</code></pre>
...
<pre><code>
segment() = #{duration =&gt; integer() | float(), title =&gt; binary(), sub_range_length =&gt; integer(), sub_range_start =&gt; integer()} | discontinuity
</code></pre>
...
Set m3u8 allow cache.</td></tr><tr><td valign="top"><a href="#discontinuity-1">discontinuity/1</a></td><td>
