...
Add a segment discontinuity.</td></tr><tr><td valign="top"><a href="#download-2">download/2</a></td><td>
Download a m3u8 and content.</td></tr><tr><td valign="top"><a href="#iframe_only-1">iframe_only/1</a></td><td>
...
<pre><code>
download(URI::<a href="#type-uri">uri()</a>, DestDir::<a href="file.md#type-filename_all">file:filename_all()</a>) -&gt; {ok, <a href="file.md#type-filename_all">file:filename_all()</a>} | {error, term()}
</code></pre>
<br />
...
<pre><code>
parse(Data::<a href="file.md#type-filename_all">file:filename_all()</a> | <a href="#type-uri">uri()</a> | binary() | string()) -&gt; {ok, <a href="#type-m3u8">m3u8()</a>} | {error, term()}
</code></pre>
<br />
